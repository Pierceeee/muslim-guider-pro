...
//
// This file is kept in integration_test/ for future on-device runs (Android/iOS).
// To run without a device, use the copy under test/integration/:
//   flutter test test/integration/broadcaster_happy_path_test.dart
//
// The test covers every screen in the broadcast loop:
