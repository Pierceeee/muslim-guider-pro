// Golden / visual-regression test for BroadcastSummaryScreen.
//
...
//   test/features/broadcaster/summary/broadcast_summary_screen_test.dart
// which passes green today.

import 'package:flutter_test/flutter_test.dart';

void main() {
  test('broadcast summary golden skipped — google_fonts offline; see TODO(T34-goldens)',
      () {}, skip: true);
}
