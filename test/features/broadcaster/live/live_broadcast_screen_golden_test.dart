// Golden / visual-regression test for LiveBroadcastScreen.
//
...
//   test/features/broadcaster/live/live_broadcast_screen_test.dart
// which passes green today.

import 'package:flutter_test/flutter_test.dart';

void main() {
  test('live broadcast golden skipped — google_fonts offline; see TODO(T34-goldens)',
      () {}, skip: true);
}
